<template>
    <IonPage>
        ...
        <IonContent class="ion-padding">
            ...
            <IonButton @click.prevent="doCreateAccount">
                SAVE
            </IonButton>
            <IonButton @click.prevent="$router.back()">
                CANCEL
            </IonButton>
        </IonContent>
    </IonPage>
...
const doCreateAccount = async () => {
    ...
    if (error) {
        ...
        const alert = await alertController
            .create({
                header: 'Error Alert',
                subHeader: 'Error Creating Account In Supabase',
        ...
        const alert = await alertController
            .create({
                header: 'Success',
                subHeader: 'Account Created In Supabase',
                buttons: ['OK'],
            });
        await alert.present();
    }
